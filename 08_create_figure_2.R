sink("C:\\Users\\Geoff\\Dropbox\\D\\projects\\scf_biz_assets\\programs\\_LOGS\\08_create_figure_2_log.txt")

##########################################################
##########################################################
##                                                      ##
## PROGRAM NAME: 08_create_figure_2                     ##
## DESCRIPTION:                                         ##
##                                                      ##  
##  trends in distribution of private business assets   ##
##                                                      ##
##########################################################
##########################################################
...
### PLOT TRENDS ###
tiff("C:\\Users\\Geoff\\Dropbox\\D\\projects\\scf_biz_assets\\figures\\figure_2.tiff",
     width=9,
     height=9,
     units='in',
     res=600)
