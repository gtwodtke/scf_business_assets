sink("C:\\Users\\Geoff\\Dropbox\\D\\projects\\scf_biz_assets\\programs\\_LOGS\\23_create_table_C2_log.txt")

##########################################################
##########################################################
##                                                      ##
## PROGRAM NAME: 23_create_table_C2                     ##
## DESCRIPTION:                                         ##
##                                                      ##  
##  fits log-normal hurdle models for overall trends    ##
##  for those with non-missing assets                   ##
##                                                      ##
##########################################################
##########################################################
