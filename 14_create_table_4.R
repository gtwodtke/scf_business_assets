sink("C:\\Users\\Geoff\\Dropbox\\D\\projects\\scf_biz_assets\\programs\\_LOGS\\14_create_table_4_log.txt")

##########################################################
##########################################################
##                                                      ##
## PROGRAM NAME: 14_create_table_4                      ##
## DESCRIPTION:                                         ##
##                                                      ##  
##  trends among SMEs only                              ##
##                                                      ##
##########################################################
##########################################################
...
### RECODE FIRM SIZE ###
scfmi$nempnum[is.na(scfmi$nempnum)]<-0
...
for (i in 1:5) {
	...
	scfpop<-scfmi[(which(scfmi$"nminum"==i & scfmi$"nempnum"<=500)),]
	scfbiz<-scfmi[which(scfmi$"nminum"==i & scfmi$"nempnum"<=500 & scfmi$"nbizvalpos"==1),]
...
scfmi<-scfmi[which(scfmi$"nminum"==1 & scfmi$"nempnum"<=500),]
scfmibiz<-scfmi[which(scfmi$"nbizvalpos"==1 & scfmi$"nempnum"<=500 & scfmi$"nminum"==1),]
...
cat("$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$\n")
cat("$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$\n")
cat("TABLE 4 - Trends including only SMEs\n")
cat("$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$\n")
cat("$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$\n")
cat("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~\n")
cat("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~\n")
