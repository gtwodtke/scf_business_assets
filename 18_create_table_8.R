sink("C:\\Users\\Geoff\\Dropbox\\D\\projects\\scf_biz_assets\\programs\\_LOGS\\18_create_table_8_log.txt")

##########################################################
##########################################################
##                                                      ##
## PROGRAM NAME: 18_create_table_8                      ##
## DESCRIPTION:                                         ##
##                                                      ##  
##  trends excluding high net-worth households          ##
##                                                      ##
##########################################################
##########################################################
...
for (i in 1:5) {
	...
	scfpop<-scfmi[(which(scfmi$"nminum"==i & scfmi$"ntop1wealth"==0)),]
	scfbiz<-scfmi[which(scfmi$"nminum"==i & scfmi$"ntop1wealth"==0 & scfmi$"nbizvalpos"==1),]
...
scfmi<-scfmi[which(scfmi$"nminum"==1 & scfmi$"ntop1wealth"==0),]
scfmibiz<-scfmi[which(scfmi$"nbizvalpos"==1 & scfmi$"ntop1wealth"==0 & scfmi$"nminum"==1),]
...
cat("$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$\n")
cat("$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$\n")
cat("TABLE 8 - Trends excl. top 1% of wealth distn\n")
cat("$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$\n")
cat("$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$\n")
cat("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~\n")
cat("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~\n")
